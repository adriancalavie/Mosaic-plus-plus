...
const std::unordered_map<std::string, Data::HelpTypes> Data::Info::HELP_LEVEL = {
	{"make <image1, ...> [flags] [flag_parameters]\n"
	 "\nflags list\n"
	 "-p",				HelpTypes::MAKE_HELP },

	{GENERAL_HELP,													HelpTypes::GENERAL_HELP},

	{"set_img_pool <sourcePath> <numberPhotosDatabase> <destinationPath> [processedImagePath], [databaseFile]> [flags] [flag_parameters]\n",								HelpTypes::SET_POOL_HELP}
